        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    int resPss = Integer.parseInt(ePss.getText().toString()) * 10;
                    int resSd = Integer.parseInt(eSd.getText().toString()) * 9;
                    int resPlp = Integer.parseInt(ePlp.getText().toString()) * 10;
                    int resOod = Integer.parseInt(eOod.getText().toString()) * 10;

                    int resVc = Integer.parseInt(eVc.getText().toString()) * 8;
                    ...
                    int resMd = Integer.parseInt(eMd.getText().toString()) * 4;
                    int resFd = Integer.parseInt(eFd.getText().toString()) * 5;
                    ...
                    resultInPercentage = (result * 100) / 863;
                    ...
                    Intent intent = new Intent(GoogleAssessmentActivity.this,ResultGoogle.class);
                    startActivity(intent);

                } catch (NumberFormatException e) {
                    Toast.makeText(GoogleAssessmentActivity.this, "Please enter valid numbers in all fields.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
